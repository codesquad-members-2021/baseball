...
public class GameStatusDTO {
    ...
    public static GameStatusDTO of(Game game, Team awayTeam, Team homeTeam, Venue userVenue) {
        ...
        return builder()
                ...
                .pitcher(PlayerDTO.of(defenseTeam.getPlayer(game.getPitcherUniformNumber())))
                .pitcherStatus(game.acquirePitcherStatus())
                .batter(PlayerDTO.of(attackTeam.getPlayer(game.getBatterUniformNumber())))
                .batterStatus(game.acquireBatterStatus())
                .base1(PlayerDTO.of(attackTeam.getPlayer(game.getBase1UniformNumber())))
                .base2(PlayerDTO.of(attackTeam.getPlayer(game.getBase2UniformNumber())))
                .base3(PlayerDTO.of(attackTeam.getPlayer(game.getBase3UniformNumber())))
